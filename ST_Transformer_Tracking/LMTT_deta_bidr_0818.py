...
def train(encode_layers,d_model,n_heads,in_dim,seq_len,pred_length,d_ff=None,dropout=0.1):
    ...
    savemat('MTT_TrainingData.mat',{'ori_traj_set':ori_traj_set,'obser_set':obser_set,'tra_traj_set':tra_traj_set,'output_results_set':output_results_set,'Traj_turn_set':Traj_turn_set})
    ...
    for i in range(iter_time):
        ...
        if (i + 1) % save_st == 0:
            ...
            torch.save(Saved_dict, f"Save_Model/ST_Transformer_0418_iter_{i+1}.pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--d_model",type=str,default=32)
    parser.add_argument("--n_heads",type=int,default=3)
    parser.add_argument("--in_dim",type=int,default=4)
    parser.add_argument("--seq_len",type=float,default=50)
